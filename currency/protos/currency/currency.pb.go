...
type StreamingRateResponse struct {
	...
	Response isStreamingRateResponse_Response `protobuf_oneof:"response"`
}
...
func (m *StreamingRateResponse) GetResponse() isStreamingRateResponse_Response {
	if m != nil {
		return m.Response
	}
	return nil
...
func (x *StreamingRateResponse) GetRateResponse() *RateResponse {
	if x, ok := x.GetResponse().(*StreamingRateResponse_RateResponse); ok {
...
func (x *StreamingRateResponse) GetError() *status.Status {
	if x, ok := x.GetResponse().(*StreamingRateResponse_Error); ok {
		return x.Error
	}
	return nil
}

type isStreamingRateResponse_Response interface {
	isStreamingRateResponse_Response()
}
...
func (*StreamingRateResponse_RateResponse) isStreamingRateResponse_Response() {}

func (*StreamingRateResponse_Error) isStreamingRateResponse_Response() {}
...
var file_currency_proto_rawDesc = []byte{
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x01, 0x52, 0x04, 0x52, 0x61, 0x74, 0x65, 0x22, 0x85, 0x01, 0x0a,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x2a, 0xb5, 0x02, 0x0a, 0x0a, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63,
	...
	0x42, 0x10, 0x1f, 0x12, 0x07, 0x0a, 0x03, 0x5a, 0x41, 0x52, 0x10, 0x20, 0x32, 0x6e, 0x0a, 0x08,
	...
	0x12, 0x3a, 0x0a, 0x0e, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x52, 0x61, 0x74,
	0x65, 0x73, 0x12, 0x0c, 0x2e, 0x52, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x16, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x52, 0x61, 0x74, 0x65,
